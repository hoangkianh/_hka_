...
if ( ! function_exists( '_hka__posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function _hka__posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', '_hka_' ),
...
if ( ! function_exists( '_hka__posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function _hka__posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', '_hka_' ),
...
if ( ! function_exists( '_hka__entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function _hka__entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', '_hka_' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', '_hka_' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( '_hka__post_thumbnail' ) ) :
	/**
